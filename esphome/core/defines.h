...
#define MASTERBUS_DEVICE_COUNT 2
#define MASTERBUS_ENTITY_COUNT 4
#define MASTERBUS_UNKNOWN_FRAME_COUNT 1
#define USE_MASTERBUS_LOG_ALL_FRAMES
#define USE_MASTERBUS_SCAN
#define USE_MASTERBUS_TEXT
#define MASTERBUS_SCAN_MAX_DEVICES 32
#define USE_MDNS
