...
uint8_t TMC2226API::crc8_(uint8_t *data, uint32_t bytes) {
  uint8_t result = 0;
  uint8_t *table;
...
void TMC2226API::set_dirty_bit_(uint8_t index, bool value) {
...
bool TMC2226API::get_dirty_bit_(uint8_t index) {
  if (index >= REGISTER_COUNT)
    return false;
...
bool TMC2226API::cache_(CacheOperation operation, uint8_t address, uint32_t *value) {
...
void TMC2226API::write_register(uint8_t address, int32_t value) {
...
int32_t TMC2226API::read_register(uint8_t address) {
...
uint32_t TMC2226API::update_field(uint32_t data, RegisterField field, uint32_t value) {
  return (data & (~field.mask)) | ((value << field.shift) & field.mask);
}

void TMC2226API::write_field(RegisterField field, uint32_t value) {
...
uint32_t TMC2226API::extract_field(uint32_t data, RegisterField field) {
...
uint32_t TMC2226API::read_field(RegisterField field) {
