...
#include "esphome/components/tmc2226_hub/tmc2226_hub.h"

namespace esphome {
namespace tmc2226 {

using namespace esphome::tmc2226_hub;

static const char *TAG = "tmc2226";
...
class TMC2226API : public Parented<TMC2226Hub> {
 public:
  TMC2226API() = default;
  TMC2226API(uint8_t address) : address_(address){};
