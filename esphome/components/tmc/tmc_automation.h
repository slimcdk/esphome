...
template<typename... Ts> class ConfigureAction : public Action<Ts...>, public Parented<TMCStepper> {
 public:
...
template<typename... Ts> class ActivationAction : public Action<Ts...>, public Parented<TMCStepper> {
...
template<typename... Ts> class CurrentsAction : public Action<Ts...>, public Parented<TMCStepper> {
 public:
...
template<typename... Ts> class StallGuardAction : public Action<Ts...>, public Parented<TMCStepper> {
 public:
...
template<typename... Ts> class CoolConfAction : public Action<Ts...>, public Parented<TMCStepper> {
 public:
...
template<typename... Ts> class ChopConfAction : public Action<Ts...>, public Parented<TMCStepper> {
 public:
...
template<typename... Ts> class PWMConfAction : public Action<Ts...>, public Parented<TMCStepper> {
 public:
...
// template<typename... Ts> class SyncAction : public Action<Ts...>, public Parented<TMCStepper> {
//  public:
//   TEMPLATABLE_VALUE(std::vector<TMCStepper *>, drivers);

//   void set_drivers(const std::vector<TMCStepper *> &drivers) { drivers_ = drivers; }
...
//     for (TMCStepper *driver : this->drivers_.value()) {
...
class OnDriverStatusTrigger : public Trigger<DriverStatusEvent> {
 public:
  explicit OnDriverStatusTrigger(TMCStepper *parent) {
...
class OnStallTrigger : public Trigger<> {
 public:
  explicit OnStallTrigger(TMCStepper *parent) {
