...
uint8_t TMCAPI::crc8_(uint8_t *data, uint32_t bytes) {
  uint8_t result = 0;
  uint8_t *table;
...
void TMCAPI::set_dirty_bit_(uint8_t index, bool value) {
...
bool TMCAPI::get_dirty_bit_(uint8_t index) {
  if (index >= REGISTER_COUNT)
    return false;
...
bool TMCAPI::cache_(CacheOperation operation, uint8_t address, uint32_t *value) {
...
void TMCAPI::write_register(uint8_t address, int32_t value) {
...
int32_t TMCAPI::read_register(uint8_t address) {
...
uint32_t TMCAPI::update_field(uint32_t data, RegisterField field, uint32_t value) {
  return (data & (~field.mask)) | ((value << field.shift) & field.mask);
}

void TMCAPI::write_field(RegisterField field, uint32_t value) {
...
uint32_t TMCAPI::extract_field(uint32_t data, RegisterField field) {
...
uint32_t TMCAPI::read_field(RegisterField field) {
