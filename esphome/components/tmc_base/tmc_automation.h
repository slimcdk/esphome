...
template<typename... Ts> class ConfigureAction : public Action<Ts...>, public Parented<TMCBaseComponent> {
 public:
...
template<typename... Ts> class ActivationAction : public Action<Ts...>, public Parented<TMCBaseComponent> {
...
template<typename... Ts> class CurrentsAction : public Action<Ts...>, public Parented<TMCBaseComponent> {
 public:
...
template<typename... Ts> class StallGuardAction : public Action<Ts...>, public Parented<TMCBaseComponent> {
 public:
...
template<typename... Ts> class CoolConfAction : public Action<Ts...>, public Parented<TMCBaseComponent> {
 public:
...
template<typename... Ts> class ChopConfAction : public Action<Ts...>, public Parented<TMCBaseComponent> {
 public:
...
template<typename... Ts> class PWMConfAction : public Action<Ts...>, public Parented<TMCBaseComponent> {
 public:
...
template<typename... Ts> class SyncAction : public Action<Ts...>, public Parented<TMCBaseComponent> {
 public:
  TEMPLATABLE_VALUE(std::vector<TMCBaseComponent *>, drivers);

  void set_drivers(const std::vector<TMCBaseComponent *> &drivers) { drivers_ = drivers; }
  ...
  void play(const Ts &...x) override {
    ...
    for (TMCBaseComponent *driver : this->drivers_.value()) {
...
class OnDriverStatusTrigger : public Trigger<DriverStatusEvent> {
 public:
  explicit OnDriverStatusTrigger(TMCBaseComponent *parent) {
...
class OnStallTrigger : public Trigger<> {
 public:
  explicit OnStallTrigger(TMCBaseComponent *parent) {
