...
#include "esphome/components/tmc_hub/tmc_hub.h"

namespace esphome {
namespace tmc_base {

using namespace esphome::tmc_hub;

static const char *TAG = "tmc_base";
...
class TMCBaseAPI : public Parented<TMCHub> {
 public:
  TMCBaseAPI() = default;
  TMCBaseAPI(uint8_t address) : address_(address){};
