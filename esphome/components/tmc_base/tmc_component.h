...
#include "tmc_base_config_dumps.h"
...
class TMCBaseComponent : public TMCBaseAPI, public Component {
 public:
  TMCBaseComponent() = default;
  TMCBaseComponent(uint8_t address) : TMCBaseAPI(address){};
