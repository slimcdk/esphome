...
#include "esphome/components/tmc2202_hub/tmc2202_hub.h"

namespace esphome {
namespace tmc2202 {

using namespace esphome::tmc2202_hub;

static const char *TAG = "tmc2202";
...
class TMC2202API : public Parented<TMC2202Hub> {
 public:
  TMC2202API() = default;
  TMC2202API(uint8_t address) : address_(address){};
