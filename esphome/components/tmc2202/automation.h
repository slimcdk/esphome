...
template<typename... Ts> class ConfigureAction : public Action<Ts...>, public Parented<TMC2202Component> {
 public:
...
template<typename... Ts> class ActivationAction : public Action<Ts...>, public Parented<TMC2202Component> {
...
template<typename... Ts> class CurrentsAction : public Action<Ts...>, public Parented<TMC2202Component> {
 public:
...
template<typename... Ts> class ChopConfAction : public Action<Ts...>, public Parented<TMC2202Component> {
 public:
...
template<typename... Ts> class PWMConfAction : public Action<Ts...>, public Parented<TMC2202Component> {
 public:
...
template<typename... Ts> class SyncAction : public Action<Ts...>, public Parented<TMC2202Component> {
 public:
  TEMPLATABLE_VALUE(std::vector<TMC2202Component *>, drivers);

  void set_drivers(const std::vector<TMC2202Component *> &drivers) { drivers_ = drivers; }
  ...
  void play(const Ts &...x) override {
    ...
    for (TMC2202Component *driver : this->drivers_.value()) {
...
class OnDriverStatusTrigger : public Trigger<DriverStatusEvent> {
 public:
  explicit OnDriverStatusTrigger(TMC2202Component *parent) {
