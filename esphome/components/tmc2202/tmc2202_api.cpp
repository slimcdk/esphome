...
uint8_t TMC2202API::crc8_(uint8_t *data, uint32_t bytes) {
  uint8_t result = 0;
  uint8_t *table;
...
void TMC2202API::set_dirty_bit_(uint8_t index, bool value) {
...
bool TMC2202API::get_dirty_bit_(uint8_t index) {
  if (index >= REGISTER_COUNT)
    return false;
...
bool TMC2202API::cache_(CacheOperation operation, uint8_t address, uint32_t *value) {
...
void TMC2202API::write_register(uint8_t address, int32_t value) {
...
int32_t TMC2202API::read_register(uint8_t address) {
...
uint32_t TMC2202API::update_field(uint32_t data, RegisterField field, uint32_t value) {
  return (data & (~field.mask)) | ((value << field.shift) & field.mask);
}

void TMC2202API::write_field(RegisterField field, uint32_t value) {
...
uint32_t TMC2202API::extract_field(uint32_t data, RegisterField field) {
...
uint32_t TMC2202API::read_field(RegisterField field) {
