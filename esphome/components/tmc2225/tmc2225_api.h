...
#include "esphome/components/tmc2225_hub/tmc2225_hub.h"

namespace esphome {
namespace tmc2225 {

using namespace esphome::tmc2225_hub;

static const char *TAG = "tmc2225";
...
class TMC2225API : public Parented<TMC2225Hub> {
 public:
  TMC2225API() = default;
  TMC2225API(uint8_t address) : address_(address){};
