...
#include "esphome/components/tmc2225/tmc2225_api.h"
#include "esphome/components/tmc2225/tmc2225_component.h"
#include "esphome/components/tmc2225/events.h"
...
class TMC2225Stepper : public TMC2225Component, public Stepper {
 public:
  TMC2225Stepper() = default;
  TMC2225Stepper(uint8_t address) : TMC2225Component(address){};
