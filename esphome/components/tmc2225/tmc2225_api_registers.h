...
#define I_SCALE_ANALOG_FIELD          ((esphome::tmc2225::RegisterField) { I_SCALE_ANALOG_MASK, I_SCALE_ANALOG_SHIFT, GCONF, false })
...
#define INTERNAL_RSENSE_FIELD         ((esphome::tmc2225::RegisterField) { INTERNAL_RSENSE_MASK, INTERNAL_RSENSE_SHIFT, GCONF, false })
...
#define EN_SPREADCYCLE_FIELD          ((esphome::tmc2225::RegisterField) { EN_SPREADCYCLE_MASK, EN_SPREADCYCLE_SHIFT, GCONF, false })
#define SHAFT_MASK                    0x08 // GCONF // controls motor direction
#define SHAFT_SHIFT                   3 // min.: 0, max.: 1, default: 0
#define SHAFT_FIELD                   ((esphome::tmc2225::RegisterField) { SHAFT_MASK, SHAFT_SHIFT, GCONF, false })
#define INDEX_OTPW_MASK               0x10 // GCONF // index_otpw
#define INDEX_OTPW_SHIFT              4 // min.: 0, max.: 1, default: 0
#define INDEX_OTPW_FIELD              ((esphome::tmc2225::RegisterField) { INDEX_OTPW_MASK, INDEX_OTPW_SHIFT, GCONF, false })
#define INDEX_STEP_MASK               0x20 // GCONF // index_step
#define INDEX_STEP_SHIFT              5 // min.: 0, max.: 1, default: 0
#define INDEX_STEP_FIELD              ((esphome::tmc2225::RegisterField) { INDEX_STEP_MASK, INDEX_STEP_SHIFT, GCONF, false })
#define PDN_DISABLE_MASK              0x40 // GCONF // pdn_disable
#define PDN_DISABLE_SHIFT             6 // min.: 0, max.: 1, default: 0
#define PDN_DISABLE_FIELD             ((esphome::tmc2225::RegisterField) { PDN_DISABLE_MASK, PDN_DISABLE_SHIFT, GCONF, false })
#define MSTEP_REG_SELECT_MASK         0x80 // GCONF // mstep_reg_select
#define MSTEP_REG_SELECT_SHIFT        7 // min.: 0, max.: 1, default: 0
#define MSTEP_REG_SELECT_FIELD        ((esphome::tmc2225::RegisterField) { MSTEP_REG_SELECT_MASK, MSTEP_REG_SELECT_SHIFT, GCONF, false })
...
#define MULTISTEP_FILT_FIELD          ((esphome::tmc2225::RegisterField) { MULTISTEP_FILT_MASK, MULTISTEP_FILT_SHIFT, GCONF, false })
#define TEST_MODE_MASK                0x0200 // GCONF // test_mode 0
#define TEST_MODE_SHIFT               9 // min.: 0, max.: 1, default: 0
#define TEST_MODE_FIELD               ((esphome::tmc2225::RegisterField) { TEST_MODE_MASK, TEST_MODE_SHIFT, GCONF, false })
#define RESET_MASK                    0x01 // GSTAT // reset
#define RESET_SHIFT                   0 // min.: 0, max.: 1, default: 0
#define RESET_FIELD                   ((esphome::tmc2225::RegisterField) { RESET_MASK, RESET_SHIFT, GSTAT, false })
#define DRV_ERR_MASK                  0x02 // GSTAT // drv_err
#define DRV_ERR_SHIFT                 1 // min.: 0, max.: 1, default: 0
#define DRV_ERR_FIELD                 ((esphome::tmc2225::RegisterField) { DRV_ERR_MASK, DRV_ERR_SHIFT, GSTAT, false })
#define UV_CP_MASK                    0x04 // GSTAT // uv_cp
#define UV_CP_SHIFT                   2 // min.: 0, max.: 1, default: 0
#define UV_CP_FIELD                   ((esphome::tmc2225::RegisterField) { UV_CP_MASK, UV_CP_SHIFT, GSTAT, false })
...
#define IFCNT_FIELD                   ((esphome::tmc2225::RegisterField) { IFCNT_MASK, IFCNT_SHIFT, IFCNT, false })
...
#define SLAVECONF_FIELD               ((esphome::tmc2225::RegisterField) { SLAVECONF_MASK, SLAVECONF_SHIFT, SLAVECONF, false })
...
#define OTPBIT_FIELD                  ((esphome::tmc2225::RegisterField) { OTPBIT_MASK, OTPBIT_SHIFT, OTP_PROG, false })
...
#define OTPBYTE_FIELD                 ((esphome::tmc2225::RegisterField) { OTPBYTE_MASK, OTPBYTE_SHIFT, OTP_PROG, false })
...
#define OTPMAGIC_FIELD                ((esphome::tmc2225::RegisterField) { OTPMAGIC_MASK, OTPMAGIC_SHIFT, OTP_PROG, false })
...
#define OTP0_BYTE_0_READ_DATA_FIELD   ((esphome::tmc2225::RegisterField) { OTP0_BYTE_0_READ_DATA_MASK, OTP0_BYTE_0_READ_DATA_SHIFT, OTP_READ, false })
...
#define OTP1_BYTE_1_READ_DATA_FIELD   ((esphome::tmc2225::RegisterField) { OTP1_BYTE_1_READ_DATA_MASK, OTP1_BYTE_1_READ_DATA_SHIFT, OTP_READ, false })
...
#define OTP2_BYTE_2_READ_DATA_FIELD   ((esphome::tmc2225::RegisterField) { OTP2_BYTE_2_READ_DATA_MASK, OTP2_BYTE_2_READ_DATA_SHIFT, OTP_READ, false })
#define ENN_MASK                      0x01 // IOIN //
#define ENN_SHIFT                     0 // min.: 0, max.: 1, default: 0
#define ENN_FIELD                     ((esphome::tmc2225::RegisterField) { ENN_MASK, ENN_SHIFT, IOIN, false })
#define MS1_MASK                      0x04 // IOIN //
#define MS1_SHIFT                     2 // min.: 0, max.: 1, default: 0
#define MS1_FIELD                     ((esphome::tmc2225::RegisterField) { MS1_MASK, MS1_SHIFT, IOIN, false })
#define MS2_MASK                      0x08 // IOIN //
#define MS2_SHIFT                     3 // min.: 0, max.: 1, default: 0
#define MS2_FIELD                     ((esphome::tmc2225::RegisterField) { MS2_MASK, MS2_SHIFT, IOIN, false })
#define DIAG_MASK                     0x10 // IOIN //
#define DIAG_SHIFT                    4 // min.: 0, max.: 1, default: 0
#define DIAG_FIELD                    ((esphome::tmc2225::RegisterField) { DIAG_MASK, DIAG_SHIFT, IOIN, false })
#define PDN_UART_MASK                 0x40 // IOIN //
#define PDN_UART_SHIFT                6 // min.: 0, max.: 1, default: 0
#define PDN_UART_FIELD                ((esphome::tmc2225::RegisterField) { PDN_UART_MASK, PDN_UART_SHIFT, IOIN, false })
#define STEP_MASK                     0x80 // IOIN //
#define STEP_SHIFT                    7 // min.: 0, max.: 1, default: 0
#define STEP_FIELD                    ((esphome::tmc2225::RegisterField) { STEP_MASK, STEP_SHIFT, IOIN, false })
#define SEL_A_MASK                    0x0100 // IOIN // Driver type
#define SEL_A_SHIFT                   8 // min.: 0, max.: 1, default: 0
#define SEL_A_FIELD                   ((esphome::tmc2225::RegisterField) { SEL_A_MASK, SEL_A_SHIFT, IOIN, false })
#define DIR_MASK                      0x0200 // IOIN //
#define DIR_SHIFT                     9 // min.: 0, max.: 1, default: 0
#define DIR_FIELD                     ((esphome::tmc2225::RegisterField) { DIR_MASK, DIR_SHIFT, IOIN, false })
...
#define VERSION_FIELD                 ((esphome::tmc2225::RegisterField) { VERSION_MASK, VERSION_SHIFT, IOIN, false })
...
#define FCLKTRIM_FIELD                ((esphome::tmc2225::RegisterField) { FCLKTRIM_MASK, FCLKTRIM_SHIFT, FACTORY_CONF, false })
...
#define OTTRIM_FIELD                  ((esphome::tmc2225::RegisterField) { OTTRIM_MASK, OTTRIM_SHIFT, FACTORY_CONF, false })
...
#define IHOLD_FIELD                   ((esphome::tmc2225::RegisterField) { IHOLD_MASK, IHOLD_SHIFT, IHOLD_IRUN, false })
...
#define IRUN_FIELD                    ((esphome::tmc2225::RegisterField) { IRUN_MASK, IRUN_SHIFT, IHOLD_IRUN, false })
...
#define IHOLDDELAY_FIELD              ((esphome::tmc2225::RegisterField) { IHOLDDELAY_MASK, IHOLDDELAY_SHIFT, IHOLD_IRUN, false })
...
#define TPOWERDOWN_FIELD              ((esphome::tmc2225::RegisterField) { TPOWERDOWN_MASK, TPOWERDOWN_SHIFT, TPOWERDOWN, false })
...
#define TSTEP_FIELD                   ((esphome::tmc2225::RegisterField) { TSTEP_MASK, TSTEP_SHIFT, TSTEP, false })
...
#define TPWMTHRS_FIELD                ((esphome::tmc2225::RegisterField) { TPWMTHRS_MASK, TPWMTHRS_SHIFT, TPWMTHRS, false })
...
#define VACTUAL_FIELD                 ((esphome::tmc2225::RegisterField) { VACTUAL_MASK, VACTUAL_SHIFT, VACTUAL, true })
#define SEMIN_MASK                    0x0000000F
#define SEMIN_SHIFT                   0
#define SEMIN_FIELD                   ((esphome::tmc2225::RegisterField) { SEMIN_MASK, SEMIN_SHIFT, COOLCONF, false })
#define SEUP_MASK                     0x00000060
#define SEUP_SHIFT                    5
#define SEUP_FIELD                    ((esphome::tmc2225::RegisterField) { SEUP_MASK, SEUP_SHIFT, COOLCONF, false })
#define SEMAX_MASK                    0x00000F00
#define SEMAX_SHIFT                   8
#define SEMAX_FIELD                   ((esphome::tmc2225::RegisterField) { SEMAX_MASK, SEMAX_SHIFT, COOLCONF, false })
#define SEDN_MASK                     0x00006000
#define SEDN_SHIFT                    13
#define SEDN_FIELD                    ((esphome::tmc2225::RegisterField) { SEDN_MASK, SEDN_SHIFT, COOLCONF, false })
#define SEIMIN_MASK                   0x00008000
#define SEIMIN_SHIFT                  15
#define SEIMIN_FIELD                  ((esphome::tmc2225::RegisterField) { SEIMIN_MASK, SEIMIN_SHIFT, COOLCONF, false })
...
#define MSCNT_FIELD                   ((esphome::tmc2225::RegisterField) { MSCNT_MASK, MSCNT_SHIFT, MSCNT, false })
...
#define CUR_A_FIELD                   ((esphome::tmc2225::RegisterField) { CUR_A_MASK, CUR_A_SHIFT, MSCURACT, true })
...
#define CUR_B_FIELD                   ((esphome::tmc2225::RegisterField) { CUR_B_MASK, CUR_B_SHIFT, MSCURACT, true })
...
#define TOFF_FIELD                    ((esphome::tmc2225::RegisterField) { TOFF_MASK, TOFF_SHIFT, CHOPCONF, false })
...
#define HSTRT_FIELD                   ((esphome::tmc2225::RegisterField) { HSTRT_MASK, HSTRT_SHIFT, CHOPCONF, false })
...
#define HEND_FIELD                    ((esphome::tmc2225::RegisterField) { HEND_MASK, HEND_SHIFT, CHOPCONF, false })
...
#define TBL_FIELD                     ((esphome::tmc2225::RegisterField) { TBL_MASK, TBL_SHIFT, CHOPCONF, false })
...
#define VSENSE_FIELD                  ((esphome::tmc2225::RegisterField) { VSENSE_MASK, VSENSE_SHIFT, CHOPCONF, false })
...
#define PWM_OFS_FIELD                 ((esphome::tmc2225::RegisterField) { PWM_OFS_MASK, PWM_OFS_SHIFT, PWM_CONF, false })
...
#define PWM_GRAD_FIELD                ((esphome::tmc2225::RegisterField) { PWM_GRAD_MASK, PWM_GRAD_SHIFT, PWM_CONF, false })
...
#define PWM_FREQ_FIELD                ((esphome::tmc2225::RegisterField) { PWM_FREQ_MASK, PWM_FREQ_SHIFT, PWM_CONF, false })
#define PWM_AUTOSCALE_MASK            0x040000 // PWM_CONF//
#define PWM_AUTOSCALE_SHIFT           18 // min.: 0, max.: 1, default: 0
#define PWM_AUTOSCALE_FIELD           ((esphome::tmc2225::RegisterField) { PWM_AUTOSCALE_MASK, PWM_AUTOSCALE_SHIFT, PWM_CONF, false })
#define PWM_AUTOGRAD_MASK             0x080000 // PWM_CONF//
#define PWM_AUTOGRAD_SHIFT            19 // min.: 0, max.: 1, default: 0
#define PWM_AUTOGRAD_FIELD            ((esphome::tmc2225::RegisterField) { PWM_AUTOGRAD_MASK, PWM_AUTOGRAD_SHIFT, PWM_CONF, false })
...
#define FREEWHEEL_FIELD               ((esphome::tmc2225::RegisterField) { FREEWHEEL_MASK, FREEWHEEL_SHIFT, PWM_CONF, false })
...
#define PWM_REG_FIELD                 ((esphome::tmc2225::RegisterField) { PWM_REG_MASK, PWM_REG_SHIFT, PWM_CONF, false })
...
#define PWM_LIM_FIELD                 ((esphome::tmc2225::RegisterField) { PWM_LIM_MASK, PWM_LIM_SHIFT, PWM_CONF, false })
...
#define PWM_SCALE_SUM_FIELD           ((esphome::tmc2225::RegisterField) { PWM_SCALE_SUM_MASK, PWM_SCALE_SUM_SHIFT, PWM_SCALE, false })
...
#define PWM_SCALE_AUTO_FIELD          ((esphome::tmc2225::RegisterField) { PWM_SCALE_AUTO_MASK, PWM_SCALE_AUTO_SHIFT, PWM_SCALE, true })
...
#define PWM_OFS_AUTO_FIELD            ((esphome::tmc2225::RegisterField) { PWM_OFS_AUTO_MASK, PWM_OFS_AUTO_SHIFT, PWM_AUTO, false })
...
#define PWM_GRAD_AUTO_FIELD           ((esphome::tmc2225::RegisterField) { PWM_GRAD_AUTO_MASK, PWM_GRAD_AUTO_SHIFT, PWM_AUTO, false })
