...
template<typename... Ts> class ConfigureAction : public Action<Ts...>, public Parented<TMC2225Component> {
 public:
...
template<typename... Ts> class ActivationAction : public Action<Ts...>, public Parented<TMC2225Component> {
...
template<typename... Ts> class CurrentsAction : public Action<Ts...>, public Parented<TMC2225Component> {
 public:
...
template<typename... Ts> class StallGuardAction : public Action<Ts...>, public Parented<TMC2225Component> {
 public:
...
template<typename... Ts> class CoolConfAction : public Action<Ts...>, public Parented<TMC2225Component> {
 public:
...
template<typename... Ts> class ChopConfAction : public Action<Ts...>, public Parented<TMC2225Component> {
 public:
...
template<typename... Ts> class PWMConfAction : public Action<Ts...>, public Parented<TMC2225Component> {
 public:
...
template<typename... Ts> class SyncAction : public Action<Ts...>, public Parented<TMC2225Component> {
 public:
  TEMPLATABLE_VALUE(std::vector<TMC2225Component *>, drivers);

  void set_drivers(const std::vector<TMC2225Component *> &drivers) { drivers_ = drivers; }
  ...
  void play(const Ts &...x) override {
    ...
    for (TMC2225Component *driver : this->drivers_.value()) {
...
class OnDriverStatusTrigger : public Trigger<DriverStatusEvent> {
 public:
  explicit OnDriverStatusTrigger(TMC2225Component *parent) {
...
class OnStallTrigger : public Trigger<> {
 public:
  explicit OnStallTrigger(TMC2225Component *parent) {
