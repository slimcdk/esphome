...
#include "esphome/components/tmc2224/tmc2224_api.h"
#include "esphome/components/tmc2224/tmc2224_component.h"
#include "esphome/components/tmc2224/events.h"
...
class TMC2224Stepper : public TMC2224Component, public Stepper {
 public:
  TMC2224Stepper() = default;
  TMC2224Stepper(uint8_t address) : TMC2224Component(address){};
