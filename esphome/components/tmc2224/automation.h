...
template<typename... Ts> class ConfigureAction : public Action<Ts...>, public Parented<TMC2224Component> {
 public:
...
template<typename... Ts> class ActivationAction : public Action<Ts...>, public Parented<TMC2224Component> {
...
template<typename... Ts> class CurrentsAction : public Action<Ts...>, public Parented<TMC2224Component> {
 public:
...
template<typename... Ts> class ChopConfAction : public Action<Ts...>, public Parented<TMC2224Component> {
 public:
...
template<typename... Ts> class PWMConfAction : public Action<Ts...>, public Parented<TMC2224Component> {
 public:
...
template<typename... Ts> class SyncAction : public Action<Ts...>, public Parented<TMC2224Component> {
 public:
  TEMPLATABLE_VALUE(std::vector<TMC2224Component *>, drivers);

  void set_drivers(const std::vector<TMC2224Component *> &drivers) { drivers_ = drivers; }
  ...
  void play(const Ts &...x) override {
    ...
    for (TMC2224Component *driver : this->drivers_.value()) {
...
class OnDriverStatusTrigger : public Trigger<DriverStatusEvent> {
 public:
  explicit OnDriverStatusTrigger(TMC2224Component *parent) {
