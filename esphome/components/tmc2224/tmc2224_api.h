...
#include "esphome/components/tmc2224_hub/tmc2224_hub.h"

namespace esphome {
namespace tmc2224 {

using namespace esphome::tmc2224_hub;

static const char *TAG = "tmc2224";
...
class TMC2224API : public Parented<TMC2224Hub> {
 public:
  TMC2224API() = default;
  TMC2224API(uint8_t address) : address_(address){};
